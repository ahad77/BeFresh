    ...
    <li class="nav-item" >
      ...
      <li class="nav-item">
        ...
        <div class="offersub1" id="Offers">
            <h2 class="text-center text-capitalize">BEVERAGE</h2>
        ...
        <div class="brands" id="Brands">
            ...
            <div class="product card"> 
                    ...
                    <?php
              $sql = "select * from beverage where id= '1' ";
              ...
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2303752 Pepsi Pet Bottle 600ml.jpg"  class="prod_img">
                        </div><!--/card-body-->
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '2' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2303756 Mountain Dew Pet Bottle 600ml.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '3' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2303754 7up Pet Bottle 600ml.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '4' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2300781 Fanta 1000 ml (pet).jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '5' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2300253_U.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '6' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2300879.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '7' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2300783_U.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '8' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2300782_U_1.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '9' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2301747.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from beverage where id= '10' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2300075 Fresh Natural Drinking Water 1.5 ltr.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">

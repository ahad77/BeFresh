    ...
    <li class="nav-item" >
      ...
      <li class="nav-item">
        ...
        <div class="offersub1" id="Offers">
            <h2 class="text-center text-capitalize copyright"><b>FRUITS</b></h2>
        ...
        <div class="brands" id="Brands">
            <h2 class="text-center text-capitalize copyright"><b>Fresh Fruits</b></h2>
            ...
            <div class="product card"> 
                    ...
                    <?php
              $sql = "select * from fruits where id= '1' ";
              ...
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901049.jpg"  class="prod_img">
                        </div><!--/card-body-->
              ...
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901266.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
              ...
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901141.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '4' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901051_19.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '5' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901107.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '6' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901120_19.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '7' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901459.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '8' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901063.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '9' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901137.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '10' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901099.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '11' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901461_19.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '12' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901454_19.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '13' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901460.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '14' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/sweet orange.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '15' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901047_2.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '16' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2900134_U.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '17' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901087_U.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '18' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901111_19 (1).jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '19' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901131_U.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from fruits where id= '20' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2901806.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
     ...
     <footer><footer class="text-center mt-5">

    ...
    <li class="nav-item" >
      ...
      <li class="nav-item">
        ...
        <div class="offersub1" id="Offers">
            <h2 class="text-center text-capitalize">COSMETICS</h2>
        ...
        <div class="brands" id="Brands">
            ...
            <div class="product card"> 
                    ...
                    <?php
              $sql = "select * from cosmetics where id= '1' ";
              ...
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/PNCC50H (1).jpg"  class="prod_img">
                        </div><!--/card-body-->
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '2' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/3006445 Vaseline Lotion Deep Restore -UL.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '3' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/3014301 Vaseline Pure Petroleum Original Jelly 100ml.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '4' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/3000707 Glow And Lovely Fairness Cream Advanced Multivitamin -UL.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '5' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/3009588 (1).jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '6' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/3005371 Clear Anti Hair Anti-Dandruff Fall Shampoo -UL.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '7' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/3014907.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '8' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/3015145.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '9' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/3000610 Lifebuoy Total Soap -UL.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from cosmetics where id= '10' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/download (1).jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">

...
<nav class="navbar  navbar-dark fixed-top " style="background: #d2b788;">
    ...
    <li class="nav-item" >
      ...
      <li class="nav-item">
        ...
        <div class="offersub1" id="Offers">
            <h2 class="text-center text-capitalize copyright"><b>MEAT</b></h2>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100 slideimg subbenar" src="images/Screenshot_42.png" alt="First slide">
                          ...
                          <div class="carousel-item">
                            <img class="d-block w-100 slideimg subbenar" src="images/Screenshot_42.png" alt="Second slide">
                            <div class="carousel-caption d-none d-md-block">
                          ...
                          <div class="carousel-item">
                            <img class="d-block w-100 slideimg subbenar" src="images/Screenshot_42.png" alt="Third slide">
                            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="brands" id="Brands">
            <h2 class="text-center text-capitalize copyright"> BEEF</h2>

            </div><!--/slides-->
            
            <div class="productsss jumbotron" id="Products"style="background: #372f2fe3;">
                ...
                <div class="product card"> 
                    ...
                    <?php
              $sql = "select * from meat where id= '1' ";
              ...
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/Screenshot_36.png"  class="prod_img">
                        </div><!--/card-body-->
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from meat where id= '2' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/Screenshot_37.png"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from meat where id= '3' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        ...
                        <img src="images/Screenshot_34.png"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from meat where id= '4' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/Screenshot_35.png"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from meat where id= '5' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>

    ...
    <li class="nav-item" >
      ...
      <li class="nav-item">
        ...
        <div class="offersub1" id="Offers">
            <h2 class="text-center text-capitalize">BABY FOOD</h2>
        ...
        <div class="brands" id="Brands">
            ...
            <div class="product card"> 
              ...
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2200664.jpg"  class="prod_img">
                        </div><!--/card-body-->
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from baby where id= '2' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2200673.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from baby where id= '3' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2200060.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from baby where id= '4' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2200144.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
                ...
                <div class="product card">
                  <div class="card-header" style="position:relative;">
                  <?php
              $sql = "select * from baby where id= '5' ";
              $result = $con->query($sql);
              if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
              ?>
                    ...
                    <div class="card-body">
                        <img src="images/2200033.jpg"  class="prod_img">
                        </div><!--/card-body-->
                <div class="Wired_Earphone">
                <div>
                <div class="logopic">
